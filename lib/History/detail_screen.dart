...
import 'package:tcms_light_app/Components/ink_well_custom.dart';
import 'package:tcms_light_app/History/driver_detail.dart';
              ...
              child: Container(
                child: Column(
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: (){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => DriverDetailScreen()));
                      },
                      child: Container(
